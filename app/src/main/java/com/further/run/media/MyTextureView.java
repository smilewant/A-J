            ...
            mMediaPlayer
                    .setOnVideoSizeChangedListener(new MediaPlayer.OnVideoSizeChangedListener() {
                        ...
                        public void onVideoSizeChanged(MediaPlayer mp,
                            ...
                            Log.e(TAG, "setOnVideoSizeChangedListener:");
...
//        listener.onPrepare();
    ...
    /**
     * @param mode Pass {@link #CENTER_CROP_MODE} or {@link #CENTER_MODE}.
     *             Default value is 0.
     */
    ...
    private void updateTextureViewSizeCenterCrop() {
        ...
        matrix.postScale(sx, sy, getWidth() / 2, getHeight() / 2);// 后两个参数坐标是以整个View的坐标系以参考的
