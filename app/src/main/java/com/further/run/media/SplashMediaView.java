...
public class SplashMediaView extends TextureView implements
    ...
    public void setUrl(String videoUrl) {
        this.url = videoUrl;
        LogUtil.e("start SplashMediaView :" + videoUrl);
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        if (mMediaPlayer == null) {
            LogUtil.e("start SplashMediaView : onSurfaceTextureAvailable");
...
//                        mediaComplete.complete();
                        if (mediaComplete != null) mediaComplete.error();
                    }
                });
                mMediaPlayer.setOnVideoSizeChangedListener(new MediaPlayer.OnVideoSizeChangedListener() {
                    @Override
                    public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
                        LogUtil.e("start SplashMediaView : onVideoSizeChanged");
//                        updateTextureViewSizeCenterCrop();
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surface, int width, int height) {
        LogUtil.e("start SplashMediaView : onSurfaceTextureSizeChanged");
        updateTextureViewSizeCenterCrop();
    }
