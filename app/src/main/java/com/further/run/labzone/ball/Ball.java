package com.further.run.labzone.ball;
...
import com.further.run.media.Constant;
...
public class Ball {
    ...
    public void initVertexData() {
        // 顶点坐标数据的初始化================begin============================
        /**
         * 原理见   https://www.tuicool.com/articles/Qjm6bmy
         */
        ...
        for (int vAngle = -90; vAngle < 90; vAngle = vAngle + angleSpan)// 垂直方向angleSpan度一份
        {
            ...
            {// 纵向横向各到一个角度后计算对应的此点在球面上的坐标
                ...
                // 将计算出来的XYZ坐标加入存放顶点坐标的ArrayList</float></float>
                alVertix.add(x1);
                alVertix.add(y1);
                alVertix.add(z1);
