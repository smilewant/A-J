...
class CityChoiceActivity : BaseActivity() {
    private var adapter: RVAdapter<CityData> ?= null
    private var citys: List<CityData>? = null
        ...
        thread {
            CityCatch.get(this)?.let {
                ...
                runOnUiThread {
                    ...
                    city_choice_recycler.scrollToPosition(currentPosition - 4)
                }
            }
        }
    }
    ...
    private fun getParam(){
        currentPosition =  intent.getIntExtra(ConstantUtil.CITY_POSITION, 0)
    }

    private fun initView() {
         adapter = object : RVAdapter<CityData>(CityChoiceActivity@ this, R.layout.common_single_textview) {
           ...
           override fun convert(holder: RVHolder<*>?, data: CityData?, positon: Int) {
               ...
               holder.itemView.setOnClickListener {
                   data?.let {
                       ...
                       intent.putExtra(ConstantUtil.CITY_POSITION, positon)
        ...
        city_choice_recycler.addItemDecoration(SectionDecoration.Builder.init(object : GroupListener {
            override fun getFloatView(): View {
