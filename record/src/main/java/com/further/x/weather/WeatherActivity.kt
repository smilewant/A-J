...
//            }
    ...
    fun weatherIcon(type: String): Int {
        return when (type) {
            "晴" -> R.drawable.weather_sunny
            "阴",
            "多云" -> R.drawable.weather_cloudy
            "小雨" -> R.drawable.weather_s_rain
            else -> R.drawable.weather_sunny
        }
    }

    fun weatherTextColor(type: String): Int {
        return ContextCompat.getColor(this, when (type) {
    ...
    fun weatherBg(type: String) : Int{
        return when(type){
            "晴" -> R.drawable.sunny_bg
            "阴",
            "多云" -> R.drawable.winter_cloud_bg
            "小雨" -> R.drawable.rain_item_bg
